#!/usr/bin/env node
/**
 * CLI lever for verifying the unpacked new-tab against live aidr.today.
 *
 ...
 *   node apps/extension/scripts/verify-newtab.mjs --out /tmp/verify-aidr-extension
 */
...
async function main() {
  const outDir = argValue("--out", "/tmp/verify-aidr-extension");
