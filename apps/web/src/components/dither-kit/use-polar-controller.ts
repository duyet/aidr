...
import type { AreaVariant, ChartConfig, Margins } from "./chart-context"
...
export function usePolarController({
  ...
  // useCallback for the same reason as registerSeries in the cartesian
  // controller: pie.tsx/radar.tsx list these as effect deps, so without
  // stable identities the unregister/register effect re-fires and its
  // setState pair loops.
