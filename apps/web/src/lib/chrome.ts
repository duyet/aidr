...
export const PHONE_PREFS_TRIGGER_CLASS = `${PHONE_TAP_TARGET_CLASS} rounded-full text-sm font-semibold text-muted-foreground hover:bg-muted hover:text-foreground`;
