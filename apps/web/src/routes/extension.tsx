  ...
  return (
    <div className="py-10">
      ...
      <p className="mt-8 max-w-3xl text-xs text-muted-foreground">
        {t(
          "Chrome will warn that the extension is unpacked. That is expected. Source lives in this monorepo at apps/extension.",
          "Chrome sẽ cảnh unpacked extension. Đó là bình thường. Mã nguồn nằm trong monorepo ở apps/extension."
        )}{" "}
        <Link
          to="/"
          className="text-accent underline underline-offset-2 hover:no-underline"
